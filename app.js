document.addEventListener("DOMContentLoaded", function() {
    ...
    pProjects.textContent = `For smaller projects, I only charge $${Math.floor(Math.random() * 100)} and for larger scale projects it can $${Math.floor(Math.random() * 100000)}.`;
