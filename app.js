document.addEventListener("DOMContentLoaded", function() {
    ...
    pWorking.textContent = `I'm obsessed with coding and trying to monetize it. I am open for hire, you can find me at denealbode@gmail.com. For smaller projects, I only charge $${Math.floor(Math.random() * 100)} and for larger scale projects it can $${Math.floor(Math.random() * 100000)}.`;
